...
//        this.setLocation(posX, posY);
    ...
    private void init() {
        ...
        ThietBi thietBi = thietbiBLL.getThietBi(Integer.parseInt(temp));
        ...
        if ((Date.get(Calendar.YEAR) == Cur.get(Calendar.YEAR)) && (Date.get(Calendar.MONTH) == Cur.get(Calendar.MONTH)) && (Date.get(Calendar.DAY_OF_MONTH) == Cur.get(Calendar.DAY_OF_MONTH))) {
            ...
            if (TimeBefore) {
                ...
                if (matvTxtField.getText() != "") {
                    ...
                    ThietBi tb = thietbiBLL.getThietBi(Integer.parseInt(matb));
                    ...
                    int id = thongTinSuDungBLL.getMaxId();
                    info.setMaTT(id + 1);
                    if (thongTinSuDungBLL.newThongTinSuDung(info) == true) {
